...
export const DataManagerImport: Story = {
  args: {
    ...
    description:
      "Connect your cloud storage or upload files from your computer",
    additionalContent: (
      <div className="flex items-center justify-center gap-base"></div>
    ),
    actions: (
      <>
        <Button variant="primary" look="filled" className="flex-1">
...
export const ComplexContent: Story = {
  args: {
    ...
    description:
      "Choose from multiple upload options and formats to get started",
    additionalContent: (
      <div className="text-center">
        <Typography
          variant="label"
          size="small"
          className="text-neutral-content-subtler mb-2"
        >
...
export const RelationsPanel: Story = {
  args: {
    ...
    description:
      "Add relations to establish connections between labeled regions",
    actions: (
